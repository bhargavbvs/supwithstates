...
// Any state, and either house: the same free-licence rule decides in
// every case, so nothing here needs to know which set it is walking.
//   node scratch/fetch-wiki-photos.mjs content/states/telangana/representatives
const repDir = process.argv[2] ?? 'content/states/andhra/representatives';
