...
filed with the Election Commission of India before the {{year}} {{state}}
assembly election. Candidates are legally required to disclose their education,
declared criminal cases, assets and liabilities, and those affidavits are public
record.
...
When we say a member has **declared criminal cases**, we mean exactly this: the
candidate disclosed pending criminal cases against them in their sworn affidavit
to the Election Commission. That is a fact about what they declared. It is not a
...
Movable, immovable, total and liabilities are **exactly as the candidate wrote
them**. We do not estimate, adjust for inflation, or editorialise. Net worth is
the one number we calculate: assets minus liabilities, and nothing else.

Amounts are in rupees, shown in crores or lakhs for readability.
...
does not have one yet: ADR has not published a winner or an affidavit for that
constituency. Those seats read as *not yet profiled* rather than being filled
with a guess.

Constituency boundaries come from the Election Commission's own published
layers. Where a state's election used boundaries newer than the layer we hold,
the state waits for better boundaries rather than filing members under a
neighbour's outline.
...
It appears on every profile page and we repeat it here: **self-declared in a
sworn affidavit to the Election Commission of India. Pending cases are
